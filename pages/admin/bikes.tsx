...
import Searchbox, { loadBikeTypes } from '../../components/searchbox';
  ...
  return (
    <Layout>
      <div className="mx-auto min-h-screen tracking-tighter text-justBlack lg:max-w-7xl">
        <div className="mx-2 rounded-md bg-offWhite p-3 lg:mx-0 lg:gap-6 lg:rounded-3xl lg:p-6">
          <div className="flex w-full flex-col items-center rounded-md bg-accentBlue/10 p-3 lg:col-start-1 lg:col-end-3 lg:h-full lg:rounded-3xl xl:p-6">
